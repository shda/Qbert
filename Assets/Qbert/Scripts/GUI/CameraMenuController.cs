...
namespace Assets.Qbert.Scripts.GUI.GUISettings
{
    public class CameraMenuController : MonoBehaviour 
    {
        ...
        public Transform rootAboutUs;
        public Transform rootLanguage;
        ...
        public void OnCameraToLanguage()
        {
            HideAllObjects(true);
            cameraController.MoveCameraToPoint(rootLanguage.position, durationMoveCameraToSettings);
        }

        public void OnCameraMoveToAboutUs()
        {
            HideAllObjects(true);
            cameraController.MoveCameraToPoint(rootAboutUs.position, durationMoveCameraToSettings);
        }
